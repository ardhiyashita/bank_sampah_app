...
public class ArtikelAdapterHome extends RecyclerView.Adapter<ArtikelAdapterHome.ViewHolder> {
    ...
    public ArtikelAdapterHome(Context context, ArrayList<Artikel>list){
    ...
    @NonNull
    @Override
    public ArtikelAdapterHome.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.list_article,parent,false);
        return new ArtikelAdapterHome.ViewHolder(view);
    }
